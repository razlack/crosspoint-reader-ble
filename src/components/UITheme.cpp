...
#include "components/themes/lyra/NewTheme.h"
...
void UITheme::setTheme(CrossPointSettings::UI_THEME type) {
  switch (type) {
    ...
    case CrossPointSettings::UI_THEME::LYRA_3_COVERS:
      ...
      break;
    case CrossPointSettings::UI_THEME::NEW_THEME:
      LOG_DBG("UI", "Using New theme");
      currentTheme = std::make_unique<NewTheme>();
      currentMetrics = &NewMetrics::values;
      break;
